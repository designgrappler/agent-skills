...
This repository uses a **Distribution Mirror** pattern. 
- **The Dashboard**: Built with Vite and Tailwind CSS.
- **The Engine**: Autogenerated metadata from raw markdown files.
- **The Mirror**: The public repository you see here is a surgically clean "Product Gallery," automatically synced from our private development workspace to ensure zero developer noise in the public view.
...
*Designed & Maintained with Surgical Precision.*
